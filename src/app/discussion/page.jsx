...
export default function SocialMediaPage() {
  ...
  const languageCategories = [
    { name: "JavaScript", icon: <Code className="w-5 h-5 text-yellow-500" />, color: "bg-yellow-100 text-yellow-800" },
    ...
    { name: "Java", icon: <FileCode2 className="w-5 h-5 text-orange-500" />, color: "bg-orange-100 text-orange-800" },
    ...
    { name: "PHP", icon: <FileCode2 className="w-5 h-5 text-purple-600" />, color: "bg-purple-100 text-purple-800" },
  ];
    ...
    <div className="bg-gray-50 min-h-screen text-gray-900">
      ...
      <div className="relative bg-gradient-to-r from-blue-800 via-indigo-700 to-blue-900 overflow-hidden">
        <div className="absolute inset-0">
          <svg className="absolute bottom-0 opacity-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#ffffff" fillOpacity="1" d="M0,160L48,144C96,128,192,96,288,106.7C384,117,480,171,576,186.7C672,203,768,181,864,154.7C960,128,1056,96,1152,101.3C1248,107,1344,149,1392,170.7L1440,192L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path>
          </svg>
        ...
        <div className="container mx-auto px-4 py-16 relative z-10">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
              Join our community of coders to solve challenges, share solutions, and elevate your programming skills.
            </p>
        ...
        <div className="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-100">
          ...
          <div className="flex items-center space-x-4 px-6 py-5 border-b border-gray-100">
            {isLoading ? (
              ...
              <img src={avatarSrc} className="w-10 h-10 rounded-full object-cover border-2 border-blue-100 shadow-sm" alt="Avatar" />
            )}
            <div 
              ...
              {posts.length > 0 ? (
                ...
                <div className="py-16 text-center text-gray-500">
                  ...
                  <p className="mt-2 text-sm text-gray-400">
                    {isSearchMode ? 'Try using different keywords' : 'Be the first to start a discussion!'}
                  </p>
                </div>
              )}
            </div>
          ...
          {!isLoading && posts.length > 0 && (
            ...
            <div className="px-6 py-5 border-t border-gray-100 bg-gray-50">
              <div className="flex justify-center items-center">
                <nav className="relative z-0 inline-flex shadow-sm rounded-md overflow-hidden" aria-label="Pagination">
              ...
              <div className="mt-3 text-center text-sm text-gray-500">
                Page {pagination.page} of {totalPages} • Showing {posts.length} of {pagination.total} discussions
              </div>
            </div>
          )}
        </div>
