    ...
    <div className="bg-gray-100 min-h-screen p-4">
      ...
      <div className="bg-white rounded-lg p-4 shadow-sm">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-700 mb-4">{contestData.description || "This CodeWars contest is sponsored by FunPlus."}</p>
              ...
              {contestData.testCases.slice(0, 2).map((testCase, index) => (
                <div key={index} className="mb-4 last:mb-0">
                  ...
                  <div className="mb-2">
                    ...
                    <code className="bg-gray-100 px-2 py-1 rounded text-gray-800">{testCase.input}</code>
                  </div>
                  <div>
                    <span className="text-gray-600 mr-2">Expected Output:</span>
                    <code className="bg-gray-100 px-2 py-1 rounded text-gray-800">{testCase.expectedOutput}</code>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>Contestants ranked <span className="font-medium">1st-5th</span> will win a FunPlus Customized T-shirt</li>
            <li>Contestants ranked <span className="font-medium">6th - 10th</span> will win a FunPlus Customized Bag</li>
            <li>Contestants ranked <span className="font-medium">11th - 15th</span> will win a FunPlus Storage Box</li>
            <li>Contestants ranked <span className="font-medium">66th, 166th, 266th, 366th, 666th</span> will win a FPX Champion Cap</li>
          </ul>
          <p className="mt-4 text-gray-700">
            Only CW(US)(codewars.com) accounts are eligible for the bonus rewards. After the ranking is finalized, a 
            CodeWars team member will reach out to you through email regarding the gift!
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <ol className="list-decimal pl-6 space-y-4">
            <li>
              To provide a better contest and ensure fairness, we listened to CodeWars users' feedback and put in lots
              of thoughts behind the updated contest rule. Please check out our new contest
              <a href="#" className="text-blue-600 hover:underline"> rule </a>
            ...
            <li>
              To ensure the fairness of the contest, CodeWars will hide some test cases during the contest. When
              users submit incorrect submissions, CodeWars will not show the hidden test cases to the users.
            </li>
            <li>The final rating of the contest will be updated within 5 working days after the contest.</li>
          </ol>
        </div>
        ...
        <div className="border-t border-gray-200 pt-4 mb-6">
          ...
          <ul className="list-disc space-y-3 pl-6">
            ...
            <li className="text-gray-800">Multiple accounts submitting similar code for the same problem.</li>
            <li className="text-gray-800">Creating unwanted discussions which interrupt other users' participation in a contest.</li>
            <li className="text-gray-800">Disclosing contest solutions in public discuss posts before the end of a contest.</li>
          </ul>
        </div>
        ...
        <div className="mb-6">
          <p className="text-gray-800 mb-3">
            ...
            for violation behaviors (such as plagiarism, cheating, etc). When a user is deemed
            violating contest rules, we will apply the following penalties on this user:
          </p>
          <ul className="list-disc space-y-3 pl-6">
            <li className="text-gray-800">
              <span className="font-medium">First violation:</span> CodeCoin amount resets to zero and a contest and discuss ban for 1 month.
            </li>
            <li className="text-gray-800">
              <span className="font-medium">Second violation:</span> Permanent account deactivation without appeal.
            </li>
          </ul>
        </div>
        ...
        <div className="mb-6">
          <p className="text-gray-800 mb-3">
            Furthermore, we encourage all participants to contribute to maintaining the justice and fairness of
            our contest. Users who submit valid violation report(s) will earn additional CodeCoins:
          </p>
          <ul className="list-disc space-y-3 pl-6">
            <li className="text-gray-800">
              For each violating participant, the first 10 users who submit the violation report towards this
              participant will each earn 200 CodeCoins.
            </li>
            <li className="text-gray-800">
